    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="<?= base_url('admin'); ?>" class="navbar-brand"><b>PPDB</b></a>
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li ><a href="<?= base_url('admin/guru'); ?>">Daftar Guru </a></li>
            <li ><a href="<?= base_url('admin/tahun_ajaran'); ?>">Tahun Ajaran</a></li>
            <li ><a href="<?= base_url('admin/calon_siswa'); ?>">Calon Siswa</a></li>
            <li ><a href="<?= base_url('admin/siswa_diterima'); ?>">Siswa Diterima</a></li>
            <li ><a href="<?= base_url('admin/siswa_ditolak'); ?>">Siswa Ditolak</a></li>
