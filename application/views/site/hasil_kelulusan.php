          ...
          <div class="row">
            ...
            <div class="col-md-6">
                  ...
                  <textarea class="form-control" readonly rows="3" > <?= $d->alamat; ?></textarea>
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail1"><h2>Status Kelulusan</h2></label> <br />
                      <?php if($d->status==0) { echo '<span class="label label-warning">Menunggu Kelulusan</span>'; } else if($d->status==1){
                         echo '<span class="label label-success">Selamat Anda Diterima di PAUD Nuruk Istiqomah</span>';
                          }
                          else echo '<span class="label label-danger">Mohon Maaf Anda Tidak Lulus, Silahkan coba kembali pada pendaftaran berikutnya !</span>'; ?> 
